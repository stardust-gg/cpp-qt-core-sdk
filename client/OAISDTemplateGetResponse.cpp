...
OAISDTemplateGetResponse::OAISDTemplateGetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISDTemplateGetResponse::OAISDTemplateGetResponse() {
    this->initializeModel();
}

OAISDTemplateGetResponse::~OAISDTemplateGetResponse() {}

void OAISDTemplateGetResponse::initializeModel() {
...
void OAISDTemplateGetResponse::fromJson(QString jsonString) {
...
void OAISDTemplateGetResponse::fromJsonObject(QJsonObject json) {
...
QString OAISDTemplateGetResponse::asJson() const {
...
QJsonObject OAISDTemplateGetResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_game_id_isSet) {
...
qint32 OAISDTemplateGetResponse::getGameId() const {
    return game_id;
}
void OAISDTemplateGetResponse::setGameId(const qint32 &game_id) {
    this->game_id = game_id;
    this->m_game_id_isSet = true;
}

bool OAISDTemplateGetResponse::is_game_id_Set() const{
    return m_game_id_isSet;
}

bool OAISDTemplateGetResponse::is_game_id_Valid() const{
    return m_game_id_isValid;
}

qint32 OAISDTemplateGetResponse::getId() const {
    return _id;
}
void OAISDTemplateGetResponse::setId(const qint32 &_id) {
    this->_id = _id;
    this->m__id_isSet = true;
}

bool OAISDTemplateGetResponse::is__id_Set() const{
    return m__id_isSet;
}

bool OAISDTemplateGetResponse::is__id_Valid() const{
    return m__id_isValid;
}

QString OAISDTemplateGetResponse::getCap() const {
    return cap;
}
void OAISDTemplateGetResponse::setCap(const QString &cap) {
    this->cap = cap;
    this->m_cap_isSet = true;
}

bool OAISDTemplateGetResponse::is_cap_Set() const{
    return m_cap_isSet;
}

bool OAISDTemplateGetResponse::is_cap_Valid() const{
    return m_cap_isValid;
}

QString OAISDTemplateGetResponse::getContractType() const {
    return contract_type;
}
void OAISDTemplateGetResponse::setContractType(const QString &contract_type) {
    this->contract_type = contract_type;
    this->m_contract_type_isSet = true;
}

bool OAISDTemplateGetResponse::is_contract_type_Set() const{
    return m_contract_type_isSet;
}

bool OAISDTemplateGetResponse::is_contract_type_Valid() const{
    return m_contract_type_isValid;
}

QString OAISDTemplateGetResponse::getTotalSupply() const {
    return total_supply;
}
void OAISDTemplateGetResponse::setTotalSupply(const QString &total_supply) {
    this->total_supply = total_supply;
    this->m_total_supply_isSet = true;
}

bool OAISDTemplateGetResponse::is_total_supply_Set() const{
    return m_total_supply_isSet;
}

bool OAISDTemplateGetResponse::is_total_supply_Valid() const{
    return m_total_supply_isValid;
}

QString OAISDTemplateGetResponse::getName() const {
    return name;
}
void OAISDTemplateGetResponse::setName(const QString &name) {
    this->name = name;
    this->m_name_isSet = true;
}

bool OAISDTemplateGetResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAISDTemplateGetResponse::is_name_Valid() const{
    return m_name_isValid;
}

QString OAISDTemplateGetResponse::getType() const {
    return type;
}
void OAISDTemplateGetResponse::setType(const QString &type) {
    this->type = type;
    this->m_type_isSet = true;
}

bool OAISDTemplateGetResponse::is_type_Set() const{
    return m_type_isSet;
}

bool OAISDTemplateGetResponse::is_type_Valid() const{
    return m_type_isValid;
}

OAISDTemplateGetAllResponse_props OAISDTemplateGetResponse::getProps() const {
    return props;
}
void OAISDTemplateGetResponse::setProps(const OAISDTemplateGetAllResponse_props &props) {
    this->props = props;
    this->m_props_isSet = true;
}

bool OAISDTemplateGetResponse::is_props_Set() const{
    return m_props_isSet;
}

bool OAISDTemplateGetResponse::is_props_Valid() const{
    return m_props_isValid;
}

OAIObject OAISDTemplateGetResponse::getPublicContractMetadata() const {
    return public_contract_metadata;
}
void OAISDTemplateGetResponse::setPublicContractMetadata(const OAIObject &public_contract_metadata) {
    this->public_contract_metadata = public_contract_metadata;
    this->m_public_contract_metadata_isSet = true;
}

bool OAISDTemplateGetResponse::is_public_contract_metadata_Set() const{
    return m_public_contract_metadata_isSet;
}

bool OAISDTemplateGetResponse::is_public_contract_metadata_Valid() const{
    return m_public_contract_metadata_isValid;
}

OAIObject OAISDTemplateGetResponse::getPublicTokenMetadata() const {
    return public_token_metadata;
}
void OAISDTemplateGetResponse::setPublicTokenMetadata(const OAIObject &public_token_metadata) {
    this->public_token_metadata = public_token_metadata;
    this->m_public_token_metadata_isSet = true;
}

bool OAISDTemplateGetResponse::is_public_token_metadata_Set() const{
    return m_public_token_metadata_isSet;
}

bool OAISDTemplateGetResponse::is_public_token_metadata_Valid() const{
    return m_public_token_metadata_isValid;
}

QList<OAISDGameGetResponse_fees_inner> OAISDTemplateGetResponse::getFees() const {
    return fees;
}
void OAISDTemplateGetResponse::setFees(const QList<OAISDGameGetResponse_fees_inner> &fees) {
    this->fees = fees;
    this->m_fees_isSet = true;
}

bool OAISDTemplateGetResponse::is_fees_Set() const{
    return m_fees_isSet;
}

bool OAISDTemplateGetResponse::is_fees_Valid() const{
    return m_fees_isValid;
}

QString OAISDTemplateGetResponse::getBlockchainContractAddress() const {
    return blockchain_contract_address;
}
void OAISDTemplateGetResponse::setBlockchainContractAddress(const QString &blockchain_contract_address) {
    this->blockchain_contract_address = blockchain_contract_address;
    this->m_blockchain_contract_address_isSet = true;
}

bool OAISDTemplateGetResponse::is_blockchain_contract_address_Set() const{
    return m_blockchain_contract_address_isSet;
}

bool OAISDTemplateGetResponse::is_blockchain_contract_address_Valid() const{
    return m_blockchain_contract_address_isValid;
}

bool OAISDTemplateGetResponse::isSet() const {
...
bool OAISDTemplateGetResponse::isValid() const {
