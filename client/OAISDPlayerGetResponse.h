...
/*
 * OAISDPlayerGetResponse.h
 *
 * This is the data output json model
 */

#ifndef OAISDPlayerGetResponse_H
#define OAISDPlayerGetResponse_H
...
class OAISDPlayerGetResponse : public OAIObject {
public:
    OAISDPlayerGetResponse();
    OAISDPlayerGetResponse(QString json);
    ~OAISDPlayerGetResponse() override;
...
Q_DECLARE_METATYPE(stardust::core::OAISDPlayerGetResponse)

#endif // OAISDPlayerGetResponse_H
