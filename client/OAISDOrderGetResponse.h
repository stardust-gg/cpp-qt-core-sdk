...
/*
 * OAISDOrderGetResponse.h
 *
 * 
 */

#ifndef OAISDOrderGetResponse_H
#define OAISDOrderGetResponse_H
...
class OAISDOrderGetResponse : public OAIObject {
public:
    OAISDOrderGetResponse();
    OAISDOrderGetResponse(QString json);
    ~OAISDOrderGetResponse() override;
...
Q_DECLARE_METATYPE(stardust::core::OAISDOrderGetResponse)

#endif // OAISDOrderGetResponse_H
