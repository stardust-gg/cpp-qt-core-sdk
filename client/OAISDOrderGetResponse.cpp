...
OAISDOrderGetResponse::OAISDOrderGetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISDOrderGetResponse::OAISDOrderGetResponse() {
    this->initializeModel();
}

OAISDOrderGetResponse::~OAISDOrderGetResponse() {}

void OAISDOrderGetResponse::initializeModel() {
...
void OAISDOrderGetResponse::fromJson(QString jsonString) {
...
void OAISDOrderGetResponse::fromJsonObject(QJsonObject json) {
...
QString OAISDOrderGetResponse::asJson() const {
...
QJsonObject OAISDOrderGetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAISDOrderGetResponse::getOfferedBy() const {
    return offered_by;
}
void OAISDOrderGetResponse::setOfferedBy(const QString &offered_by) {
    this->offered_by = offered_by;
    this->m_offered_by_isSet = true;
}

bool OAISDOrderGetResponse::is_offered_by_Set() const{
    return m_offered_by_isSet;
}

bool OAISDOrderGetResponse::is_offered_by_Valid() const{
    return m_offered_by_isValid;
}

QString OAISDOrderGetResponse::getAcceptedBy() const {
    return accepted_by;
}
void OAISDOrderGetResponse::setAcceptedBy(const QString &accepted_by) {
    this->accepted_by = accepted_by;
    this->m_accepted_by_isSet = true;
}

bool OAISDOrderGetResponse::is_accepted_by_Set() const{
    return m_accepted_by_isSet;
}

bool OAISDOrderGetResponse::is_accepted_by_Valid() const{
    return m_accepted_by_isValid;
}

QList<OAISDOrderGetAllResponse_tokensRequested_inner> OAISDOrderGetResponse::getTokensRequested() const {
    return tokens_requested;
}
void OAISDOrderGetResponse::setTokensRequested(const QList<OAISDOrderGetAllResponse_tokensRequested_inner> &tokens_requested) {
    this->tokens_requested = tokens_requested;
    this->m_tokens_requested_isSet = true;
}

bool OAISDOrderGetResponse::is_tokens_requested_Set() const{
    return m_tokens_requested_isSet;
}

bool OAISDOrderGetResponse::is_tokens_requested_Valid() const{
    return m_tokens_requested_isValid;
}

QList<OAISDOrderGetAllResponse_tokensRequested_inner> OAISDOrderGetResponse::getTokensOffered() const {
    return tokens_offered;
}
void OAISDOrderGetResponse::setTokensOffered(const QList<OAISDOrderGetAllResponse_tokensRequested_inner> &tokens_offered) {
    this->tokens_offered = tokens_offered;
    this->m_tokens_offered_isSet = true;
}

bool OAISDOrderGetResponse::is_tokens_offered_Set() const{
    return m_tokens_offered_isSet;
}

bool OAISDOrderGetResponse::is_tokens_offered_Valid() const{
    return m_tokens_offered_isValid;
}

QString OAISDOrderGetResponse::getStatus() const {
    return status;
}
void OAISDOrderGetResponse::setStatus(const QString &status) {
    this->status = status;
    this->m_status_isSet = true;
}

bool OAISDOrderGetResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAISDOrderGetResponse::is_status_Valid() const{
    return m_status_isValid;
}

bool OAISDOrderGetResponse::isSet() const {
...
bool OAISDOrderGetResponse::isValid() const {
